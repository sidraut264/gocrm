...
function StageColumn({ 
    ...
    return (
        <div className={`
            rounded-xl border-2 border-gray-200 dark:border-gray-700 border-t-4
            min-w-[320px] max-w-[320px] flex-shrink-0 h-fit
            ...
            <div className="container mx-auto px-3 py-6 max-w-7xl">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-8 gap-4">
                    <div>
                        ...
                        <p className="text-gray-600 dark:text-gray-400 mt-1">
                            Track and manage your deals • {deals.length} total opportunities
                        </p>
                    </div>
                ...
                <div className="relative mb-6 max-w-md">
                    ...
                    <Input
                        ...
                        className="pl-10 bg-white dark:bg-gray-800 border-gray-300 dark:border-gray-600 shadow-sm"
                    />
                </div>
                        ...
                        {filteredDeals.length === 0 ? (
                            <div className="text-center py-16">
                                ...
                                <p className="text-gray-500 dark:text-gray-500 text-sm mt-2">
                                    {searchTerm ? "Try adjusting your search terms" : "Create your first deal to get started"}
                                </p>
                            </div>
                        ) : (
                            <Table>
                                <TableHeader>
                                    <TableRow className="bg-gray-50 dark:bg-gray-700">
                                        <TableHead className="font-semibold">Deal Title</TableHead>
